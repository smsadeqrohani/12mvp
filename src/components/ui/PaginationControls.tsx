  ...
  return (
    <View className="flex-row items-center justify-between px-6 py-4 border-t border-gray-700/30 bg-gray-800/20">
      <View className="flex-row items-center gap-2">
        <Text className="text-sm text-gray-400" style={{ fontFamily: 'Vazirmatn-Regular' }}>
      ...
      <View className="flex-row items-center gap-2">
        ...
        >
          ...
          <Text className={`text-sm font-medium ${currentPage === 1 || isLoading ? "text-gray-600" : "text-white"}`} style={{ fontFamily: 'Vazirmatn-SemiBold' }}>
            قبلی
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
          ...
          activeOpacity={0.7}
        >
          <Text className={`text-sm font-medium ${isDone || isLoading ? "text-gray-600" : "text-white"}`} style={{ fontFamily: 'Vazirmatn-SemiBold' }}>
            بعدی
          </Text>
